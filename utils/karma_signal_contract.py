...
class KarmaSignal:
    ...
    def __init__(self, subject_id: str, product_context: str, signal: str, 
                 severity: float = 0.0, opaque_reason_code: str = "GENERIC", 
        ...
        Args:
            ...
            opaque_reason_code: Opaque reason code for the signal (no human-readable explanations)
    ...
    @classmethod
    def create_signal(cls, subject_id: str, product_context: str, signal: str, 
                      severity: float = 0.0, opaque_reason_code: str = "GENERIC",
        ...
        """
        return cls(subject_id, product_context, signal, severity, opaque_reason_code, ttl, requires_core_ack)
...
def emit_canonical_karma_signal(subject_id: str, product_context: str, signal: str,
    ...
    """
    karma_signal = KarmaSignal(subject_id, product_context, signal, severity, opaque_reason_code, ttl, requires_core_ack)
...
def evaluate_constraint_signal(user_id: str, action: str, product_context: str) -> Optional[Dict[str, Any]]:
    """
    ...
    Args:
        ...
        product_context: Context where the action occurs
